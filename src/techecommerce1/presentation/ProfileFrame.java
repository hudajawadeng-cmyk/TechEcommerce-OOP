...
public class ProfileFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        nameLbl.setFont(new Font("Monospaced", Font.BOLD, 18));
        nameLbl.setForeground(Color.WHITE);
        JLabel emailLbl = new JLabel(userEmail);
        emailLbl.setFont(new Font("Monospaced", Font.PLAIN, 14));
        emailLbl.setForeground(new Color(200, 230, 255));
        JLabel memberLbl = new JLabel("Member since: May 2025");
        memberLbl.setFont(new Font("Monospaced", Font.ITALIC, 13));
        ...
        countryBox.setBackground(new Color(235,238,244));
        countryBox.setForeground(TEXT_DIM);
        countryBox.setFont(new Font("Monospaced", Font.PLAIN, 14));
        ...
        pwLbl.setFont(new Font("Monospaced", Font.PLAIN, 13));
