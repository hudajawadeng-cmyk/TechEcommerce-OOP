...
public class OrdersFrame extends JFrame implements OrderObserver {
    ...
    private void initComponents() {
        ...
        title.setForeground(new Color(0, 140, 90));
        ...
        filterLbl.setFont(new Font("Monospaced", Font.PLAIN, 14));
        filterBox = new JComboBox<>(new String[]{"All","Processing","Shipped","In Transit","Delivered","Cancelled"});
        filterBox.setBackground(new Color(255,255,255));
        filterBox.setForeground(TEXT_DIM);
        filterBox.setFont(new Font("Monospaced", Font.PLAIN, 14));
        ...
        ordersTable.setForeground(TEXT_DIM);
        ordersTable.setGridColor(new Color(222,225,232));
        ordersTable.setFont(new Font("Monospaced", Font.PLAIN, 14));
        ordersTable.setSelectionBackground(new Color(0,150,110,140));
        ordersTable.setSelectionForeground(TEXT_MAIN);
        ...
        ordersTable.getColumnModel().getColumn(4).setCellRenderer(new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                switch (s) {
                    case "Delivered":  l.setForeground(SUCCESS_C); l.setBackground(new Color(224,247,234)); break;
                    case "In Transit": l.setForeground(ACCENT);    l.setBackground(new Color(222,235,255)); break;
                    case "Processing": l.setForeground(new Color(180,120,0)); l.setBackground(new Color(255,244,214)); break;
                    case "Cancelled":  l.setForeground(ERROR_C);   l.setBackground(new Color(255,228,230)); break;
        ...
        ordersTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                JLabel l = (JLabel) super.getTableCellRendererComponent(t,v,sel,foc,r,c);
                l.setOpaque(true);
                l.setBackground(sel ? new Color(0,150,110,140) :
