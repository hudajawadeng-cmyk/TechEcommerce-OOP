...
import techecommerce1.application.ProductService;
...
public class AddProductFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        categoryBox.setBackground(new Color(235,238,244));
        categoryBox.setForeground(TEXT_MAIN);
        categoryBox.setFont(new Font("Monospaced",Font.PLAIN,14));
        ...
        for (int i = 0; i < labels.length; i++) {
            ...
            l.setFont(new Font("Monospaced",Font.PLAIN,13)); l.setForeground(TEXT_DIM);
            card.add(l, gc);
    ...
    private JTextField darkField() {
        ...
        f.setBackground(new Color(235,238,244)); f.setForeground(TEXT_MAIN);
        f.setCaretColor(ACCENT); f.setFont(new Font("Monospaced",Font.PLAIN,14));
