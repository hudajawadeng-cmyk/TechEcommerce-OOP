...
public class ProductListFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        searchField.setBackground(new Color(255,255,255)); searchField.setForeground(TEXT_MAIN);
        searchField.setCaretColor(ACCENT); searchField.setFont(new Font("Monospaced",Font.PLAIN,14));
        ...
        productTable.setBackground(new Color(255,255,255)); productTable.setForeground(TEXT_MAIN);
        productTable.setGridColor(new Color(222,225,232));
        productTable.setFont(new Font("Monospaced",Font.PLAIN,14));
        productTable.setSelectionBackground(new Color(0,140,200,140));
        productTable.setSelectionForeground(TEXT_MAIN);
        ...
        productTable.getColumnModel().getColumn(6).setCellRenderer(new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                if (s.equals("In Stock"))      { l.setForeground(SUCCESS_C);           l.setBackground(new Color(224,247,234)); }
                else if (s.equals("Low Stock")){ l.setForeground(new Color(180,120,0));l.setBackground(new Color(255,244,214)); }
                else                           { l.setForeground(ERROR_C);             l.setBackground(new Color(255,228,230));}
        ...
        productTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                JLabel l = (JLabel) super.getTableCellRendererComponent(t,v,sel,foc,r,c);
                l.setOpaque(true);
                l.setBackground(sel ? new Color(0,140,200,140) :
