...
public class InventoryFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        title.setForeground(new Color(70, 75, 190));
        ...
        summary.add(statCard("Total SKUs",   "10", new Color(0,120,190)));
        summary.add(statCard("In Stock",      "7", new Color(0,140,90)));
        summary.add(statCard("Low Stock",     "2", new Color(190,140,0)));
        summary.add(statCard("Out of Stock",  "1", new Color(200,45,65)));
        ...
        inventoryTable.getColumnModel().getColumn(6).setCellRenderer(new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                switch (v == null ? "" : v.toString()) {
                    case "OK":           l.setForeground(SUCCESS_C);            l.setBackground(new Color(224,247,234));  break;
                    case "Low Stock":    l.setForeground(new Color(180,120,0)); l.setBackground(new Color(255,244,214)); break;
                    case "Out of Stock": l.setForeground(ERROR_C);              l.setBackground(new Color(255,228,230)); break;
        ...
        inventoryTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                JLabel l = (JLabel) super.getTableCellRendererComponent(t,v,sel,foc,r,c);
                l.setOpaque(true);
                l.setBackground(sel ? new Color(70,110,220,140) :
    ...
    private JPanel statCard(String label, String value, Color accent) {
        ...
        JLabel num = new JLabel(value); num.setFont(new Font("Monospaced",Font.BOLD,24)); num.setForeground(accent);
        JLabel nam = new JLabel(label); nam.setFont(new Font("Monospaced",Font.PLAIN,13)); nam.setForeground(TEXT_DIM);
        p.add(num); p.add(nam);
        return p;
    }
