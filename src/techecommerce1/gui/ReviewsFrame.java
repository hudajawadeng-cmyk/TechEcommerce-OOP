...
public class ReviewsFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        productBox.setBackground(new Color(25,32,55)); productBox.setForeground(TEXT_MAIN);
        ...
        ratingBox.setBackground(new Color(25,32,55)); ratingBox.setForeground(new Color(255,200,0));
        ...
        comLbl.setFont(new Font("Monospaced",Font.PLAIN,11));
        writePanel.add(comLbl, gc);

        gc.gridy++; gc.weighty = 1; gc.fill = GridBagConstraints.BOTH;
        reviewArea = new JTextArea(5,18);
        reviewArea.setBackground(new Color(25,32,55)); reviewArea.setForeground(TEXT_MAIN);
